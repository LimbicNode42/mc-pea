...
Utility for loading agent configurations from the centralized configs/agent_managers.yaml file.
...
class AgentConfigLoader:
    ...
    def __init__(self, config_file_path: Optional[str] = None):
        ...
        Args:
            config_file_path: Optional path to config file. Defaults to agent_managers.yaml in configs directory.
        """
        if config_file_path is None:
            # Default to agent_managers.yaml in the configs directory
            current_dir = Path(__file__).parent  # core directory
            ai_agents_root = current_dir.parent  # ai-agents directory
            config_file_path = ai_agents_root / "configs" / "agent_managers.yaml"
